      ...
      >
        <Box sx={{ padding: 2, width: '400px', display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          <FormControl fullWidth variant="outlined" size="small">
            <InputLabel id="refetch-label">Refetch Interval</InputLabel>
            <Select
              labelId="refecth-label"
              id="refetch-select"
              label="Refetch Interval"
              defaultValue={refetchIntervalMs}
              inputRef={refetchInputRef}
            >
              <MenuItem value={30_000}>30 seconds</MenuItem>
              <MenuItem value={60_000}>1 minute</MenuItem>
              <MenuItem value={5 * 60_000}>5 minutes</MenuItem>
            </Select>
          </FormControl>
